...
//		}
	...
	public float[] stats(String hyp, List<String> refs) {
		...
		return toFloatArray(intSuffStats);
	}
	...
	public double score(double[] suffStats) {
		...
		int[] intStats = toIntArray(suffStats);
		MeteorStats stats = new MeteorStats(intStats);
		scorer.computeMetrics(stats);
		return stats.score;
	}

	private static int[] toIntArray(double[] suffStats) {
	...
	private static float[] toFloatArray(int[] intSuffStats) {
